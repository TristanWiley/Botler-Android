 ...
 */
public class DemoCard extends RecyclerView.Adapter<DemoCard.ViewHolder> {
    private Context mContext;
    private List<Game> mDetails;

    public DemoCard(Context context, List<Game> games) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.demo_card_item, parent, false));
    }
